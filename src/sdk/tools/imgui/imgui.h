...
#if !defined(IMGUI_DISABLE_DEMO_WINDOWS) || defined(IMGUI_PERF_INTERNAL_BUILD)
...
#endif
#if !defined(IMGUI_DISABLE_DEBUG_TOOLS) || defined(IMGUI_PERF_INTERNAL_BUILD)
...
#if !IMGUI_PERF_SLIM_WIDGETS || defined(IMGUI_PERF_INTERNAL_BUILD)
...
#elif defined(IMGUI_PERF_INTERNAL_BUILD)
    IMGUI_API void          TreePop();
#endif
...
#if IMGUI_PERF_ENABLE_CLIPBOARD || defined(IMGUI_PERF_INTERNAL_BUILD)
    IMGUI_API const char*   GetClipboardText();
    IMGUI_API void          SetClipboardText(const char* text);
#endif

#if IMGUI_PERF_ENABLE_INI_SETTINGS || defined(IMGUI_PERF_INTERNAL_BUILD)
