...
// Tables and the legacy Columns API are intentionally unavailable in the slim build.
// Keep only the tiny set of entry points referenced by the retained core/widgets code.
// BeginTable() always returning false also preserves the usual safe call pattern:
//     if (BeginTable(...)) { ...; EndTable(); }
bool ImGui::BeginTable(const char*, int, ImGuiTableFlags, const ImVec2&, float)
{
    return false;
}
...
void ImGui::TablePushColumnChannel(int)
{
}
...
void ImGui::TableUpdateLayout(ImGuiTable*)
{
}

void ImGui::TableApplyExternalUnclipRect(ImGuiTable*, ImRect&)
{
}

void ImGui::TableEndRow(ImGuiTable*)
{
}

void ImGui::TableEndCell(ImGuiTable*)
{
}

void ImGui::TableGcCompactTransientBuffers(ImGuiTable*)
{
}

void ImGui::TableGcCompactTransientBuffers(ImGuiTableTempData*)
{
}
